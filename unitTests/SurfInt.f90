...
REAL                           :: Flux_nVar(PP_nVarDet,0:NRef,0:NRefZ,1:nSidesRef)
REAL                           :: Ut(PP_nVarDet,0:NRef,0:NRef,0:NRefZ,nElemsRef),Ut_ref(1,0:NRef,0:NRef,0:NRefZ,nElemsRef)
#if FV_ENABLED
REAL                           :: FV_Ut(PP_nVarDet,0:NRef,0:NRef,0:NRefZ,nElemsRef),FV_Ut_ref(1,0:NRef,0:NRef,0:NRefZ,nElemsRef)
#endif
...
#endif
! Call SurfInt
CALL SurfInt(PP_nVarDet,NRef,Flux_nVar,Flux_nVar,Ut,.FALSE.,L_HatMinus,L_HatPlus)
#if FV_ENABLED
FV_Elems = 1
FV_Elems_master = 1
FV_Elems_slave = 1
CALL SurfInt(PP_nVarDet,NRef,Flux_nVar,Flux_nVar,FV_Ut,.FALSE.,L_HatMinus,L_HatPlus)
#endif
...
ELSE
  ...
  IF (binaryExists) THEN
    ...
    equal =  .TRUE.
    DO i=1,PP_nVarDet; DO j=0,NRef; DO k=0,NRef; DO l=0,NRefZ
