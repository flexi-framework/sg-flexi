...
!===================================================================================================================================
CALL OpenDataFile(filename,create=.FALSE.,single=.FALSE.,readOnly=.TRUE.,communicator=MPI_COMM_WORLD)
...
CALL OpenDataFile(filename_out,create=.FALSE.,single=.FALSE.,readOnly=.FALSE.,communicator=MPI_COMM_WORLD)
offset=0
DO i=1,f%nDataSets
  n=f%nDims(i)
