...
INTEGER,ALLOCATABLE,TARGET        :: mapDGElemsToAllElems(:)     !< maps element index of DG elements to all elements
INTEGER,ALLOCATABLE,TARGET        :: mapFVElemsToAllElems(:)     !< maps element index of FV elements to all elements
LOGICAL,ALLOCATABLE               :: FV_Elems_loc(:,:)           !< current distribution of FV/DG elems
LOGICAL,ALLOCATABLE               :: FV_Elems_old(:,:)           !< previous distribution of FV/DG elems
...
INTEGER                               :: nVarMult                !< number of variables with stochastic quantities (Mean,Std,UofXi)
INTEGER                               :: nVarPerMesh             !< number of variables without stoch quantities (e.g. ElemData)
INTEGER                               :: nMult                   !<
...
CHARACTER(LEN=255),ALLOCATABLE,TARGET :: VarNamesVisu(:)          !< all available varnames (state file + dependent vars + generic)
...
REAL,ALLOCATABLE,TARGET               :: U(:,:,:,:,:,:)          !< rank 6 array as stoch multi elem pendant to DG u
...
REAL,ALLOCATABLE,TARGET               :: UCalcMean(:,:,:,:,:)
REAL,ALLOCATABLE,TARGET               :: UCalcStd (:,:,:,:,:)
REAL,ALLOCATABLE,TARGET               :: UCalcMean_FV(:,:,:,:,:)
REAL,ALLOCATABLE,TARGET               :: UCalcStd_FV(:,:,:,:,:)
...
LOGICAL                               :: doCalcStd
LOGICAL                               :: doCalcUofXi
LOGICAL                               :: doCalcStoch(3)
REAL,ALLOCATABLE                      :: xiEval(:)
...
INTEGER                           :: nValN(3)
INTEGER                           :: nQPUse
LOGICAL,ALLOCATABLE               :: UofXiOnThisMesh(:)
LOGICAL,ALLOCATABLE               :: ThisMeshIsNeeded(:)
REAL,ALLOCATABLE                  :: Psi_UofXi(:)
REAL,ALLOCATABLE                  :: U_NVisu(:,:,:,:)
REAL,ALLOCATABLE,TARGET           :: UTmp(:,:,:,:),UTmpMean(:,:,:,:),UTmpStd(:,:,:,:),UTmpUofXi(:,:,:,:)
