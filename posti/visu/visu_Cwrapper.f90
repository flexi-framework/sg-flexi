...
USE MOD_VTK         ,ONLY: WriteCoordsToVTK_array,WriteDataToVTK_array,WriteVarnamesToVTK_array_SG,WriteVarnamesToVTK_array,CARRAY
IMPLICIT NONE
! INPUT / OUTPUT VARIABLES
!-----------------------------------------------------------------------------------------------------------------------------------
INTEGER,INTENT(IN)            :: mpi_comm_IN    
...
CALL WriteVarnamesToVTK_array_SG(nVarVisu,varnames_out,VarNamesVisu)
