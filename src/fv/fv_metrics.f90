...
CALL U_Mortar1(1,FV_dx_master,FV_dx_slave,doMPISides=.TRUE.)
...
#endif
CALL U_Mortar1(1,FV_dx_master,FV_dx_slave,doMPISides=.FALSE.)

FV_Elems_master = 0 ! Force use of DG mortar matrices in U_Mortar routine
#if USE_MPI
CALL U_Mortar1(1,DG_dx_master,DG_dx_slave,doMPISides=.TRUE.)
...
CALL FinishExchangeMPIData(2*nNbProcs,MPIRequest) !Send MINE -receive YOUR
#endif
CALL U_Mortar1(1,DG_dx_master,DG_dx_slave,doMPISides=.FALSE.)
