...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! Low-storage Runge-Kutta 4, 10 stages
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
CASE('ssprk4-10')
  TimeDiscName = 'SSP RK 4-10'
  nRKStages=10
#if (PP_NodeType==1)
  CFLScaleAlpha(1:15) = &
...
!  END IF
  ...
  RelativeDFL=1.853
#endif
ALLOCATE(RKA(2:nRKStages),RKb(1:nRKStages),RKc(1:nRKStages))
RKA(2:nRKStages)= 1.
RKb(1:nRKStages)= 1/6.*(/1.,1.,1.,1.,1.,1.,1.,1.,1.,6/10./)
RKc(1:nRKStages)=1/6.*(/0.,1.,2.,3.,4.,2.,3.,4.,5.,6./)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
