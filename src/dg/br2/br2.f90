...
CALL Flux_MortarPrim(PP_nVarPrim,FluxX,FluxX,doMPISides=.FALSE.,weak=.FALSE.)
CALL Flux_MortarPrim(PP_nVarPrim,FluxY,FluxY,doMPISides=.FALSE.,weak=.FALSE.)
#if PP_dim == 3
CALL Flux_MortarPrim(PP_nVarPrim,FluxZ,FluxZ,doMPISides=.FALSE.,weak=.FALSE.)
#endif
...
CALL Flux_MortarPrim(PP_nVarPrim,FluxX,FluxX,doMPISides=.TRUE.,weak=.FALSE.)
CALL Flux_MortarPrim(PP_nVarPrim,FluxY,FluxY,doMPISides=.TRUE.,weak=.FALSE.)
#if PP_dim == 3
CALL Flux_MortarPrim(PP_nVarPrim,FluxZ,FluxZ,doMPISides=.TRUE.,weak=.FALSE.)
#endif
