...
CALL Flux_MortarPrim(PP_nVarPrim,gradUx_master,gradUx_master,doMPISides=.FALSE.,weak=doWeakLifting)
CALL Flux_MortarPrim(PP_nVarPrim,gradUy_master,gradUy_master,doMPISides=.FALSE.,weak=doWeakLifting)
#if (PP_dim==3)
CALL Flux_MortarPrim(PP_nVarPrim,gradUz_master,gradUz_master,doMPISides=.FALSE.,weak=doWeakLifting)
#endif
...
! Attention: we only have one Flux (gradUx/y/z_master) for the Lifting 
!            => input it to Flux_Mortar for both fluxes (master/slave)
CALL Flux_MortarPrim(PP_nVarPrim,gradUx_master,gradUx_master,doMPISides=.TRUE.,weak=doWeakLifting)
CALL Flux_MortarPrim(PP_nVarPrim,gradUy_master,gradUy_master,doMPISides=.TRUE.,weak=doWeakLifting)
#if (PP_dim==3)
CALL Flux_MortarPrim(PP_nVarPrim,gradUz_master,gradUz_master,doMPISides=.TRUE.,weak=doWeakLifting)
#endif
! compute surface integral contribution and add to ut
...
CALL ApplyJacobianPrim(PP_nVarPrim,gradUx,toPhysical=.TRUE.,FVE=0)
CALL ApplyJacobianPrim(PP_nVarPrim,gradUy,toPhysical=.TRUE.,FVE=0)
#if (PP_dim==3)
CALL ApplyJacobianPrim(PP_nVarPrim,gradUz,toPhysical=.TRUE.,FVE=0)
#endif
...
CALL ProlongToFacePrim(PP_nVarPrim,PP_N,gradUx,gradUx_master,gradUx_slave,L_Minus,L_Plus,doMPISides=.TRUE.)
CALL U_MortarPrim(PP_nVarPrim,gradUx_master,gradUx_slave,doMPISides=.TRUE.)
CALL StartSendMPIData(   gradUx_slave,DataSizeSidePrim,1,nSides,MPIRequest_gradU(:,1,SEND),SendID=2)
CALL ProlongToFacePrim(PP_nVarPrim,PP_N,gradUy,gradUy_master,gradUy_slave,L_Minus,L_Plus,doMPISides=.TRUE.)
CALL U_MortarPrim(PP_nVarPrim,gradUy_master,gradUy_slave,doMPISides=.TRUE.)
CALL StartSendMPIData(   gradUy_slave,DataSizeSidePrim,1,nSides,MPIRequest_gradU(:,2,SEND),SendID=2)
#if (PP_dim==3)
CALL ProlongToFacePrim(PP_nVarPrim,PP_N,gradUz,gradUz_master,gradUz_slave,L_Minus,L_Plus,doMPISides=.TRUE.)
CALL U_MortarPrim(PP_nVarPrim,gradUz_master,gradUz_slave,doMPISides=.TRUE.)
CALL StartSendMPIData(   gradUz_slave,DataSizeSidePrim,1,nSides,MPIRequest_gradU(:,3,SEND),SendID=2)
#endif
#endif /*USE_MPI*/

! Prolong to face for BCSides, InnerSides and MPI sides - receive direction
CALL ProlongToFacePrim(PP_nVarPrim,PP_N,gradUx,gradUx_master,gradUx_slave,L_Minus,L_Plus,doMPISides=.FALSE.)
CALL ProlongToFacePrim(PP_nVarPrim,PP_N,gradUy,gradUy_master,gradUy_slave,L_Minus,L_Plus,doMPISides=.FALSE.)
#if (PP_dim==3)
CALL ProlongToFacePrim(PP_nVarPrim,PP_N,gradUz,gradUz_master,gradUz_slave,L_Minus,L_Plus,doMPISides=.FALSE.)
#endif
CALL U_MortarPrim(PP_nVarPrim,gradUx_master,gradUx_slave,doMPISides=.FALSE.)
CALL U_MortarPrim(PP_nVarPrim,gradUy_master,gradUy_slave,doMPISides=.FALSE.)
#if (PP_dim==3)
CALL U_MortarPrim(PP_nVarPrim,gradUz_master,gradUz_slave,doMPISides=.FALSE.)
#endif
