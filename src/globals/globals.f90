...
INTEGER           ::myRank,myLocalRank,myLeaderRank,myWorkerRank,mySGElemRank
INTEGER           ::nProcessors,nLocalProcs,nLeaderProcs,nWorkerProcs
INTEGER,ALLOCATABLE :: nProcsPerSGElem(:)                                       !< number of processor per mesh
...
INTEGER           ::MPI_COMM_SGELEM                                             !< all nodes in mesh
INTEGER           ::MPI_COMM_SGELEMROOT                                         !< all meshroots in global mesh
...
LOGICAL           ::MPISGElemRoot                                               !< flag whether process is MPI root for local mesh
#if USE_MPI
