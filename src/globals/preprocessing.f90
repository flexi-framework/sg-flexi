...
#endif
#ifndef PP_M
INTEGER               :: PP_M                              !< polynomial degree of basis in stochastic space
INTEGER               :: PP_nCoef                          !< PP_M + 1
INTEGER               :: PP_nVar                           !< polynomial degree
INTEGER               :: PP_nVarQuad                       !< nQP*PP_nVarDet
INTEGER               :: PP_nVarPrim                       !< polynomial degree
#endif
#ifndef PP_nDimStoch
INTEGER               :: PP_nDimStoch
#endif
