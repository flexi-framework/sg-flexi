...
REAL,ALLOCATABLE     :: BCData_Quad(:,:,:,:,:) !< array with precomputed BC values (conservative)
REAL,ALLOCATABLE     :: BCDataPrim_Quad(:,:,:,:,:) !< array with precomputed BC values (primitive)
...
CHARACTER(LEN=255),ALLOCATABLE :: StrVarNamesPrim(:)
CHARACTER(LEN=255),ALLOCATABLE :: StrVarNamesDet(:)
CHARACTER(LEN=255),ALLOCATABLE :: StrVarNamesPrimDet(:)
